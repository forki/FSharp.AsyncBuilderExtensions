...
let website = "/FSharp.AsyncBuilderExtensions"

let githubLink = "http://github.com/sillyotter/FSharp.AsyncBuilderExtensions"

// Specify more information about your project
let info =
  [ "project-name", "FSharp.AsyncBuilderExtensions"
    "project-author", "Guy Oliver"
    "project-summary", "Extenions to the AsyncBuilder to allow Tasks to be used in an async block"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/FSharp.AsyncBuilderExtensions" ]
